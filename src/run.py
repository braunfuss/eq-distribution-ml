# ==============================================================================
# Andreas Steinberg, 2019.
# based on scripts from tensorflow and Hamid Younesy.
...
if __name__ == '__main__':
    test = False # to false if you want to use real data
    if test is False:
        get_events.create_event_file()
    run = Run()
    run.execute_runs(run.MODE_PSA_RUNS, 1, resume=True, test=test)
